...
import { AITutorView } from '@/components/dashboard/ai-tutor-view';
        ...
        >
          <div className="w-full px-4 max-w-[1600px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              {/* Sidebar - Fixed height or scrolling is handled within the component and aside */}
              <div className="lg:col-span-3 sticky top-28">
                <Sidebar />
              </div>

              {/* Main Workspace - AI Tutor (9 Columns) */}
