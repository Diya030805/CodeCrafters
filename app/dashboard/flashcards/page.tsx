...
import { FlashcardsView } from '@/components/dashboard/flashcards-view';
...
export default function FlashcardsPage() {
  return (
    <main className="min-h-screen bg-slate-50 text-slate-800 dark:bg-[#0B0C0E] dark:text-white relative overflow-x-hidden transition-colors duration-300">
      ...
      <div className="absolute top-[60%] right-[10%] w-[600px] h-[600px] bg-emerald-600/5 dark:bg-emerald-600/10 blur-[140px] rounded-full pointer-events-none z-0" />
        ...
        >
          <div className="w-full px-4 max-w-[1600px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              {/* Main Flashcards Workspace - 9 Columns */}
